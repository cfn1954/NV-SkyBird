...
{  
   ...
   else
   {
	...
	//fread(buf,sizeof(unsigned char),dataSize,fp) ; moved below to give bytes read
	//fclose(fp);
   ...
   //Display the info about the WAVE file
	...
	system("read");                                             //Stop let the sound play
...
ENDOFCODE
./temp
read  //this keeps the terminal window open you can see errors
*/
